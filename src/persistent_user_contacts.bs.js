...
var NactPersistencePostgres = require("nact-persistence-postgres");
...
var system = Nact.start(/* Some */[new NactPersistencePostgres.PostgresPersistenceEngine("postgresql://localhost:5432")], /* () */0);

function createContactsService(parent, userId) {
  return Nact.spawnPersistent("contacts" + userId, /* Some */[userId], /* None */0, /* None */0, parent, (function (state, param, param$1) {
                var msg = param[1];
                var sender = param[0];
                return Curry._1(param$1[/* persist */4], /* tuple */[
                              sender,
                              msg
                            ]).then((function () {
                              var tmp;
...
var promise1 = createErlich.then(createDinesh2);
...
exports.createDinesh2         = createDinesh2;
exports.findDinsheh2          = findDinsheh2;
